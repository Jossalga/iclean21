<%-- 
    Document   : medallas
    Created on : Apr 3, 2016, 10:37:32 PM
    Author     : josuesdiaz
--%>
      ...
      <div class="container">
        <div class="row">
          <div class="section-top wow animated fadeInUp" data-wow-delay=".5s">
            <h2 class="section-title"><span>Deportistas</span> Con Medallas</h2>
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Medallas</h4>
        </div>
   ...
   <form role="form">
      <label for="usr">Tipo de Medalla</label>
